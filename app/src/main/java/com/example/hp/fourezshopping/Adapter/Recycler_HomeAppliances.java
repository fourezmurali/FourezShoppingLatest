...
public class   Recycler_HomeAppliances {
    ...
    public Recycler_HomeAppliances() {

    }


    public Recycler_HomeAppliances(String title, String description, String category, int thumbnail, int thumbnailfirst, int thumbnailsecond, int thumbnailthird) {
        Title = title;
