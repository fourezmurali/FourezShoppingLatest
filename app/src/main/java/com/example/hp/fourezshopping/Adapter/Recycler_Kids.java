...
public class Recycler_Kids {
    ...
    public Recycler_Kids() {

    }


    public Recycler_Kids(String title, String description, String category, int thumbnail, int thumbnailfirst, int thumbnailsecond, int thumbnailthird) {
        Title = title;
