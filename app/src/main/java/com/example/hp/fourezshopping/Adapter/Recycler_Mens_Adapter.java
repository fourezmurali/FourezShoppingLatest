...
public class Recycler_Mens_Adapter extends RecyclerView.Adapter<Recycler_Mens_Adapter.MyViewHolder> {

    private Context context;
    private List<Recycler_Mens> mData;

    public Recycler_Mens_Adapter(Context context, List<Recycler_Mens> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view=mInflater.inflate(R.layout.cardview_mens_collection,parent,false);
