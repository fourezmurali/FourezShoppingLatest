...
public class Recycler_Womens_Adapter extends RecyclerView.Adapter<Recycler_Womens_Adapter.MyViewHolder> {

    private Context context;
    private List<Recycler_Womens> mData;

    public Recycler_Womens_Adapter(Context context, List<Recycler_Womens> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view=mInflater.inflate(R.layout.cardview_womens_collection,parent,false);
