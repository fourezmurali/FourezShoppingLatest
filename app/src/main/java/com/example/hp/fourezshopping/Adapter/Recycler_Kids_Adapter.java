...
public class Recycler_Kids_Adapter extends RecyclerView.Adapter<Recycler_Kids_Adapter.MyViewHolder> {

    private Context context;
    private List<Recycler_Kids> mData;

    public Recycler_Kids_Adapter(Context context, List<Recycler_Kids> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view=mInflater.inflate(R.layout.cardview_kids_collection,parent,false);
