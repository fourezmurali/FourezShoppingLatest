...
public class Recycler_Womens {
    ...
    public Recycler_Womens() {

    }


    public Recycler_Womens(String title, String description, String category, int thumbnail, int thumbnailfirst, int thumbnailsecond, int thumbnailthird) {
        Title = title;
