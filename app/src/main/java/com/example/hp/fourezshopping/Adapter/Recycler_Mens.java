...
public class Recycler_Mens {
    ...
    public Recycler_Mens() {

    }


    public Recycler_Mens(String title, String description, String category, int thumbnail, int thumbnailfirst, int thumbnailsecond, int thumbnailthird) {
        Title = title;
